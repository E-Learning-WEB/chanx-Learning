...
<footer id="contact" class="page-footer default_color scrollspy">
    ...
    <div class="footer-copyright default_color">
        <div class="container">
            (C) <a class="white-text" href="#">English Course</a> All Right Reserved. 
            Design By <a class="white-text">Ahmad Nazirul,</a>
            Thanks to 
            <a class="white-text" href="http://materializecss.com/">materializecss</a> And 
            <a class="white-text" href="http://joashpereira.com">Joash Pereira</a> For perfect materialize xD
        </div>
    </div>
</footer>
